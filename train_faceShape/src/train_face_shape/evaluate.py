...
from train_face_shape.datasets import FaceShapeFolderDataset, build_eval_transforms
from train_face_shape.model import load_model_for_inference
from train_face_shape.utils import get_device, invert_mapping, load_label_mapping, load_yaml, resolve_path, save_json
...
def evaluate(config_path: str | Path) -> dict:
    ...
    test_dataset = FaceShapeFolderDataset(
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate the exported face shape classifier.")
