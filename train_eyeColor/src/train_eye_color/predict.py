...
from train_eye_color.datasets import build_eval_transforms
from train_eye_color.model import load_model_for_inference
from train_eye_color.utils import get_device, invert_mapping, load_label_mapping, load_yaml, resolve_path
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict eye color for one image.")
