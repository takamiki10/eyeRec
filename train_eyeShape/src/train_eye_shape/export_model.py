...
def export_to_app(
    ...
    destination_dir: str | Path = "../eyewear_recommendation_system/models/feature_extractors/eye_shape",
) -> tuple[Path, Path]:
    ...
    model_source = source_dir / "eye_shape_model.pt"
    ...
    model_destination = destination_dir / "eye_shape_model.pt"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export eye shape model artifacts into the main EyeRec app.")
    parser.add_argument("--source_dir", default="artifacts/exported", help="Folder containing exported artifacts.")
    parser.add_argument(
        "--destination_dir",
        default="../eyewear_recommendation_system/models/feature_extractors/eye_shape",
