...
from train_eye_shape.datasets import build_eval_transforms
from train_eye_shape.model import load_model_for_inference
from train_eye_shape.utils import get_device, invert_mapping, load_label_mapping, load_yaml, resolve_path
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict eye shape for one image.")
